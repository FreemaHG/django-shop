...
import app.config.utils.saving_fales
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "site_url",
                    models.URLField(max_length=150, null=True, verbose_name="URL"),
                ),
                (
                    "logo_head",
                    models.ImageField(
                        upload_to=app.config.utils.saving_fales.saving_logo,
                ...
                (
                    ...
                    models.ManyToManyField(
                        to="app_shop.categoryproduct", verbose_name="Избранные товары"
                    ),
                ),
            ],
            options={
