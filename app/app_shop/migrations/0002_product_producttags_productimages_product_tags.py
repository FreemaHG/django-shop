    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount', models.PositiveIntegerField(default=0, validators=[django.core.validators.MaxValueValidator(90)], verbose_name='Скидка (в %)')),
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_shop.categoryproduct', verbose_name='Категория')),
            ],
            options={
                'verbose_name': 'Товар',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to=app_shop.utils.models.saving_files.saving_images_for_product, verbose_name='Изображение')),
        ...
        migrations.AddField(
            model_name='product',
            name='tags',
            field=models.ManyToManyField(to='app_shop.producttags', verbose_name='Теги'),
        ),
    ]
