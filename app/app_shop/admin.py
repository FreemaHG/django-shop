...
from .models.cart_and_orders import Cart, Order, PurchasedProduct, PaymentErrors
...
class ProductTagsAdmin(admin.ModelAdmin):
    ...
    fieldsets = (("Основное", {"fields": ("name", "slug", "deleted")}),)
...
class PaymentErrorsAdmin(admin.ModelAdmin):
    ...
    def formfield_for_dbfield(self, db_field, **kwargs):
        ...
        """
        formfield = super(PaymentErrorsAdmin, self).formfield_for_dbfield(
            db_field, **kwargs
        )
