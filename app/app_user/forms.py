...
class AuthUserForm(EmailForm):
    ...
    password = forms.CharField(
        widget=forms.PasswordInput, label="Пароль", help_text="Введите пароль"
    )
...
class RegisterUserForm(UserCreationForm):
    ...
    full_name = forms.CharField(
        min_length=2, max_length=150, label="ФИО", help_text="Введите полное имя"
    )
    ...
    avatar = forms.ImageField(
        required=False, label="Аватар", help_text="Выберите аватар"
    )
